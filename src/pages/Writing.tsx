      ...
      <div className="w-full h-[70%] pt-[25%] md:pt-0 md:w-[50%] md:h-[70%] md:min-w-[800px] md:min-h-[400px] flex flex-col justify-center items-center">
        ...
        <div className="downPart w-[90%] h-[20%] mx-auto flex justify-center items-center">
          ...
          <div className="w-[90%] h-full flex justify-center items-center">
            <span className="cursor-default text-transparent text-xs md:text-xs">그린펜 익명 고민 상담</span>
            <button
              className={`w-18 h-8 text-xs md:w-20 md:h-10 md:text-base rounded-xl text-gray-500 hover:text-gray-700 beigeColor2 shadow active:translate-y-0.5 transition-transform duration-100`}
